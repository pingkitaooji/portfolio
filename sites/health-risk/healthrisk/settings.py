...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "django-insecure-m0yxympoft#7i8tcr!fz3s=k#m7@-$ekp_i8a6ycb*2&$0w30i")
...
if os.getenv("POSTGRES_DB"):
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("POSTGRES_DB", "healthrisk"),
            "USER": os.getenv("POSTGRES_USER", "healthrisk"),
            "PASSWORD": os.getenv("POSTGRES_PASSWORD", "healthrisk"),
